...
import { projects, miscellaneous, section3Title, section4Title, section5Title, SideProj } from '../../profile'
    ...
    return (
        <>
            ...
            <div data-aos="zoom-in-up" data-aos-once="true" className="third">
                <>
                    <div className="pp-head-line mx-auto text-center">
                        <h1 id="SideProj" className="red-line pp-head">{section5Title}</h1>
                    </div>
                </>
                <div className="row">
                    {SideProj && SideProj.map((x) =>
                        <Project key={x.id} id={x.id} url={x.url} name={x.name} skills={x.skills} />
                    )}
                </div>
            </div>
